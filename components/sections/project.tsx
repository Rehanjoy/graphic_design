...
export function Project() {
  const stats = [
    { number: "230+", label: "Engineering Solutions", color: "bg-[#FF8FB1]" },
    { number: "50+", label: "Industry Workshops", color: "bg-[#B5B1FF]" },
    { number: "39K+", label: "Professionals", color: "bg-[#FFD84D]" },
