        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-12">
            <div className="space-y-6">
              ...
              >
                We Engineer Reliable Solutions Using <br />
              ...
              >
                Driving excellence in engineering since 2010. We transform ideas
                into tangible solutions and craft engineering marvels that make
                a difference.
              </motion.p>
            </div>
