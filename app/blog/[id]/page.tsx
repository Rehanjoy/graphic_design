...
export default function BlogDetail({ params }: { params: { id: string } }) {
  ...
  const blog = blogs.find((b) => b.id === String(params.id));
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        <section className="relative rounded-xl bg-[#0D0D12] flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="space-y-2 relative text-center p-6 max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-l from-purple-400 via-pink-500 to-yellow-500 text-transparent bg-clip-text">
              {blog.title}
            </h1>
